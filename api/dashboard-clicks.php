...
$daily = [];
$st = $pdo->query("SELECT date, total_count FROM clicks_daily ORDER BY date DESC LIMIT 365");
...
// Hoje: linhas ainda na tabela clicks
$todayRows = [];
$st = $pdo->prepare("SELECT label, platform, device, clicked_at, source FROM clicks WHERE clicked_at >= ? ORDER BY clicked_at DESC LIMIT 500");
